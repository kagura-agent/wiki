...
- [agent-tool-supply-chain-poisoning](cards/agent-tool-supply-chain-poisoning.md)
...
- [Audit-Read Tool Counting Canon](cards/audit-read-tool-counting-canon.md)
- [Authority Breach vs Quality Gate](cards/authority-breach-vs-quality-gate.md)
...
- [Command Approval Context Gap](cards/command-approval-context-gap.md)
...
- [Convergence Engine](cards/convergence-engine.md)
...
- [Datalog Context Engine — 用演绎数据库做 LLM 上下文](cards/datalog-context-engine.md)
...
- [Disk-Slot Mutex (dead-PID reclaim + grace window)](cards/disk-slot-mutex.md)
...
- [Durable Agent Runs](cards/durable-agent-runs.md)
- [Durable State, Local Capability, and Spend Authority](cards/durable-state-local-capability-spend-authority.md)
### E
...
- [Error taxonomy must key on status fields, not message-pattern matching](cards/error-taxonomy-status-over-message.md)
...
- [Exec Safety](cards/exec-safety.md)
...
- [Failable verification](cards/failable-verification.md)
- [Failure-Scope Recovery](cards/failure-scope-recovery.md)
- [FFN-Free Architectures for Structured Routing Tasks](cards/ffn-free-routing.md)
- [Floway](cards/floway.md)
- [FlowForge Workflow Engine](cards/flowforge-workflow-engine.md)
...
- [Fork Network Star-Farming Check](cards/fork-network-star-farming-check.md)
...
- [Graded Agent Guardrails](cards/graded-agent-guardrails.md)
...
- [Idempotent Operations for Agent Infrastructure](cards/idempotent-agent-infrastructure-ops.md)
...
- [local-state-concurrent-guard](cards/local-state-concurrent-guard.md)
...
- [MCP Server](cards/mcp-server.md)
...
- [Obligation-Anchored Replanning](cards/obligation-anchored-replanning.md)
...
- [OPC (One Person Company)](cards/opc.md)
...
- [Operational maturity is an agent-tool ecosystem signal](cards/operational-maturity-agent-tools.md)
...
- [Policy Gates Need a Progress Path](cards/policy-gate-progress-path.md)
...
- [Pushed-at Misleading](cards/pushed-at-misleading.md)
### Q
...
- [Reproducible Evaluation Envelope](cards/reproducible-evaluation-envelope.md)
...
- [Scallop — 半环 Datalog 引擎](cards/scallop.md)
...
- [Shell-Free Execution](cards/shell-free-execution.md)
...
- [Single-Writer Spawn Ledger](cards/single-writer-spawn-ledger.md)
...
- [Verification-Preserving Escalation](cards/verification-preserving-escalation.md)
...
- [ABTI workloop fallback — 2026-08-08](projects/abti-workloop-fallback-2026-08-08.md)
...
- [Agent Ecosystem Scout 2026-08-19 (workloop discover)](projects/agent-ecosystem-scout-2026-08-19.md)
...
- [Agent-Safe Pipeline (decionis/agent-safe-pipeline)](projects/agent-safe-pipeline.md)
...
- [agent-vision-toolkit — task-aware vision adapter for text-only coding agents](projects/agent-vision-toolkit.md)
- [agno (agno-agi/agno)](projects/agno.md)
- [aict — Structured Unix Coreutils for AI Agents](projects/aict.md)
...
- [Alego — everything-is-a-plugin 的 dsh fork（观察）](projects/alego.md)
...
- [Approving — Visual, Recoverable Agent Delivery Workflows](projects/approving.md)
...
- [bbarit-agent-oss — Rust Coding Agent CLI](projects/bbarit-agent-oss.md)
...
- [book-to-skill — ⚠️ 确认为凭证窃取木马（不要安装）](projects/book-to-skill.md)
...
- [Cindy — Multi-Harness Unified AI Agent Desktop](projects/cindy.md)
...
- [Compiled Harness Pattern](projects/compiled-harness-pattern.md)
- [Computer Anthology — continuously evolving terminal-agent benchmark (public evidence limited)](projects/computer-anthology.md)
- [Context Diet — Claude Code Prompt-Overhead Skill](projects/context-diet-claude-code.md)
- [Context Warp Drive](projects/context-warp-drive.md)
- [Control Flow Over Prompts — HN Essay (2026-05-07)](projects/control-flow-over-prompts.md)
- [cove-plugin](projects/cove-plugin.md)
- [Cove Plugin Message Actions — 架构调研笔记](projects/cove-plugin-message-actions.md)
...
- [deepseek-harness-pr-review (nexpeakcore) — 深读笔记](projects/deepseek-harness-pr-review.md)
...
- [deer-workflow — Code-First Agent Workflow Runtime](projects/deer-workflow.md)
- [deja-vu — Cross-Harness Agent Memory Search](projects/deja-vu.md)
...
- [dsh-ios — DSH 的 iOS Simulator/真机 live 插件](projects/dsh-ios.md)
- [dsh-lowtide — 错峰批量任务调度插件（dsh 生态）](projects/dsh-lowtide.md)
...
- [easylink-ai-open/agent-runtime — Standalone Agent Loop Kernel](projects/easylink-agent-runtime.md)
...
- [FableCut — Agent-Drivable Browser Video Editor](projects/fablecut.md)
- [家庭管家 — 产品构想](projects/family-butler.md)
- [fastctx](projects/fastctx.md)
...
- [Forall (astrio-labs/forall)](projects/forall-astrio.md)
...
- [Gauntlet Loop — Bar-Driven Builder/Critic Prompt Skill](projects/gauntlet-loop.md)
...
- [GoalFlow — Dify-to-LangGraph Workflow/Agent Bridge](projects/goal-flow.md)
...
- [Graft — Code-Graph Context Layer for Coding Agents](projects/graft.md)
- [Graphenium — Architecture Gate & Linter for AI Coding Agents](projects/graphenium.md)
...
- [headcount — Claude Code 的 agent 组织（16 部门 / 146 skills / CI 强制 surface map）](projects/headcount.md)
...
- [Hwatu — Verification Browser for AI Coding Agents](projects/hwatu.md)
- [HyperAgents (Facebook Research)](projects/hyperagents.md)
### I

- [InduSecAgent — an industrial anomaly-detection demo with advisory operational safeguards](projects/indusecagent.md)
...
- [JobHuntBot (DanielPan12/JobHuntBot) — 深读笔记](projects/jobhuntbot.md)
...
- [Lemmalog — Datalog 引擎作为 LLM agent 记忆](projects/lemmalog.md)
...
- [Lobster0 — OpenClaw-inspired self-hosted personal agent](projects/lobster0.md)
...
- [LoopX — local-first control plane for long-running agents](projects/loopx.md)
- [Lottie Studio](projects/lottie-studio.md)
...
- [MCP-Memory — OKF-Backed Agent Memory Server (fellowgeek/mcp-memory)](projects/mcp-memory.md)
- [MCP Slim Guard — recoverable MCP result delivery](projects/mcp-slim-guard.md)
...
- [Memory Forest — Verifiable Layered Memory for Long-Running Agents](projects/memory-forest.md)
...
- [memraw (TetiAI)](projects/memraw.md)
...
- [mentor — Session-Insights Skill for Coding Agents](projects/mentor-smixs.md)
...
- [mindwalk — 3D Coding-Agent Session Replay](projects/mindwalk.md)
...
- [MkAgent — Pi-powered local-first agent workspace](projects/mkagent.md)
...
- [multi-agent-workflow-lab (MAWL)](projects/multi-agent-workflow-lab.md)
...
- [Nightcrawler — Offline Mobile Pentest Agent](projects/nightcrawler.md)
- [Noisegate — Differential Privacy Gateway for Untrusted AI Agents](projects/noisegate.md)
- [no-no-debug — 深读笔记](projects/no-no-debug.md)
- [nuphus-mcp — Stdio MCP Desktop Automation](projects/nuphus-mcp.md)
### O

- [OASIS (camel-ai/oasis)](projects/oasis.md)
- [Observal — Cross-Harness AI Component Registry & Analytics](projects/observal.md)
- [obsidian-wiki](projects/obsidian-wiki.md)
- [OfficeBuddy — render-verified Office document agent](projects/officebuddy.md)
- [OfficeCLI — Agent-First Office Suite](projects/officecli.md)
...
- [optim-plans — Dual-Ring Planning & Execution Controller](projects/optim-plans.md)
- [OptMem — Binary Merge Tree Memory for AI Agents](projects/optmem-binary-merge-memory.md)
...
- [OpenTelemetry GenAI agent tracing — evaluation](projects/otel-genai-agent-tracing.md)
### P
...
- [PAXM — Provider-Neutral Persistent Memory for Coding Agents](projects/paxm-memory.md)
- [peerd — Browser-Native AI Agent Harness](projects/peerd-browser-agent.md)
- [Pentest Harness — dsh 垂直化 rebrand 产品（offensive-security harness）](projects/pentest-harness.md)
- [pew — AI 编程工具的 contribution graph](projects/pew.md)
- [Phantom (ghostwright)](projects/phantom.md)
- [Phoenix — Hermes Plugin for Routing and Guardrails](projects/phoenix-hermes-plugin.md)
...
- [Pilot Harness — DeepSeek Harness 桌面客户端（CodePilot 风格）](projects/pilot-harness.md)
...
- [Poirot — Deep Research Agent Kernel](projects/poirot.md)
...
- [Prime Agent — Self-Improving RLM Agent for Coding](projects/prime-agent.md)
- [Project Glasswing (Anthropic)](projects/project-glasswing.md)
- [ProofRun — Local Verification Receipts for AI Coding Agents](projects/proofrun.md)
...
- [qm — Multiplayer Agent Harness for Work](projects/qm.md)
...
- [Qwen-CUA — screenshot-only browser-use reference agent](projects/qwen-cua.md)
- [QwenPaw (agentscope-ai/QwenPaw)](projects/qwenpaw.md)
### R

- [ralph — Enterprise Loop Runner (Santander)](projects/ralph-loop-runner.md)
- [Ratchet — post-edit complexity guard for coding agents](projects/ratchet.md)
- [RealReplicaBench — stateful, reproducible business-workflow benchmark](projects/realreplicabench.md)
...
- [Scalex HITL Permission-Fatigue Data](projects/scalex-permission-fatigue.md)
...
- [Secondwind — Lossless Provable Tool Output Compression for AI Agents](projects/secondwind.md)
...
- [SHE — Trajectory-driven Safety Harness Evolution](projects/she.md)
- [Shikigami — Parallel Coding Agents Desktop IDE](projects/shikigami.md)
...
- [Sigbound — Parallel Agent Merge Engine](projects/sigbound.md)
...
- [SkillForge — Local-First Executable Skill Runtime](projects/skillforge.md)
...
- [Skill Sunset — 指令老化审计 CLI](projects/skill-sunset.md)
...
- [Skybridge — alpic-ai/skybridge](projects/skybridge.md)
- [SmallCode — Coding Agent for Small Local LLMs](projects/smallcode.md)
- [sofagent (KongFangXun/sofagent)](projects/sofagent.md)
- [Software Periodic Table (NullLabTests)](projects/software-periodic-table.md)
- [solo-skills — 一人公司技能包（观察）](projects/solo-skills.md)
- [Soul Grader Skill](projects/soul-grader-skill.md)
- [source-reading-methodology — 带 AI 精读大型仓库的方法论](projects/source-reading-methodology.md)
...
- [Sprocket — Durable cloud-local hardware/software agent platform](projects/sprocket.md)
...
- [Superserve — Firecracker MicroVM Sandbox for AI Agents](projects/superserve.md)
...
- [TabTin — 人与 Agent 协作平台](projects/tabtin.md)
...
- [TencentDB-Agent-Memory](projects/tencentdb-agent-memory.md)
...
- [understory — Self-Wiring Markdown Memory for AI Agents](projects/understory.md)
- [Universal Memory Protocol (UMP)](projects/universal-memory-protocol.md)
- [unslothai/unsloth](projects/unsloth.md)
### V
...
- [VinvAI — Runtime Evidence + Closed-Loop Verification for Coding Agents](projects/vinv-ai.md)
- [vscode-icons](projects/vscode-icons.md)
### W

- [Waggle — Attributed Artifact References for Agent Handoffs](projects/waggle.md)
- [waku-agent (ShenSeanChen)](projects/waku-agent.md)
...
- [Wattage — Token-Spend Profiler & Cost-Regression Gate](projects/wattage.md)
...
- [Workloop reflection — instance #7843](projects/workloop-reflection-7843.md)
