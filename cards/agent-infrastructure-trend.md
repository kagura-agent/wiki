...
4. **Multi-agent orchestration**: relaydeck (58⭐), loushang (47⭐), agent-symphony (9⭐), [[agentspace]] (649⭐, agents as team members in messaging channels). Platforms for coordinating multiple coding agents.
...
7. **Agent-first tooling**: [[officecli]] (13.7k⭐, agent-drivable Office suite), [[fablecut]] (253⭐, agent-drivable video editor), [[kastor-declarative-agent-spec]] (50⭐, Terraform-style declarative agent specs). Tools built from the ground up with agents as primary users.
