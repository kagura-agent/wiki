...
3. **Codebase knowledge extraction**: metatron (13⭐) — tree-sitter-based convention discovery, serve to agents via MCP. Convention extraction > convention documentation.
