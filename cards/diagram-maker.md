...
- [[projects/officecli]] — agent-first Office suite with render→look→fix visual feedback loop
- [[projects/fablecut]] — agent-drivable video editor with document-as-interface pattern
