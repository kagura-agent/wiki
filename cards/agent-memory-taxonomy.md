...
- [[agentmemory]] — TypeScript memory library (rohitg00), contribution target
- [[poirot]] — five-layer cognitive memory (lazy Ebbinghaus decay, HumanMessage injection, consolidation daemon)
